...
const SearchBooks = () => {
  ...
  {isFocused && (
    <div className="absolute bg-white border border-gray-200 rounded-xl w-full mt-2 max-h-80 overflow-y-auto 
      ...
      {isLoading ? (
            ...
            >
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[#800020] font-medium text-base truncate">{book.title}</p>
        ...
        <div className="text-center py-10 px-6">
          ...
          <p className="text-gray-500 text-sm mt-2">Zkuste použít jiná klíčová slova nebo změnit typ vyhledávání.</p>
        </div>
      ) : (
        <div className="text-center py-10 px-6">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto text-gray-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <p className="text-gray-600 font-medium">Začněte psát pro vyhledávání</p>
          <p className="text-gray-500 text-sm mt-2">Zadejte nejméně 3 znaky pro zobrazení výsledků.</p>
        </div>
      )}
    </div>
  )}
