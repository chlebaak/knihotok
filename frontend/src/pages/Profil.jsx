  ...
  const fetchUserBooks = async () => {
    try {
      const response = await axios.get(
        ...
        }/api/user-books/profile/${id}/books`,
        {
          withCredentials: true,
        }
      );
              ...
              {favorites.length > 0 ? (
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                  ...
                  <p className="text-gray-600 font-medium">
                    Zatím žádné oblíbené knihy.
                  </p>
                  <p className="text-gray-500 text-sm mt-2">
                    Knihy můžeš přidat do oblíbených na jejich detailní stránce.
                  </p>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {toRead.length > 0 ? (
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                  ...
                  <p className="text-gray-600 font-medium">
                    Zatím žádné knihy k přečtení.
                  </p>
                  <p className="text-gray-500 text-sm mt-2">
                    Knihy můžeš přidat do seznamu na jejich detailní stránce.
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in">
            ...
            {posts.length > 0 ? (
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                ...
                <p className="text-gray-500 text-sm mt-2">
                  Uživatel zatím nepřidal žádné příspěvky do komunity.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in">
            ...
            {reviews.length > 0 ? (
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                ...
                <p className="text-gray-500 text-sm mt-2">
                  Uživatel zatím nepřidal žádné recenze knih.
                </p>
              </div>
            )}
          </div>
